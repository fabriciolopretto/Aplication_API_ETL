...
if __name__ == "__main__":
    ...
    df_station_metadata_trusted = modificar_campos(df_station_metadata_trusted, campos_nuevos=['ICAO','Latitud','Longitud','M.S.N.M.','País'])
    # Procesamiento Datos:
