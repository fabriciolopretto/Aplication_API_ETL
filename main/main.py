...
if __name__ == "__main__":
    ...
    # public.metadata_estaciones
    # public.data_temperature
    # public.max_temperature
    # public.min_temperature
    werehouse_read(filename, tabla='public.data_temperature') 

    print('--'*30)

    # Visualizacion de prueba de los DataFrames que se guardan en la capa "refined" del Data Lake
